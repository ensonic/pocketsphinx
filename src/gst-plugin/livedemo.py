...
class DemoApp(object):
    ...
    def element_message(self, bus, msg):
        ...
        if msg.structure['final']:
            self.final_result(msg.structure['hypothesis'], msg.structure['probability'])
            self.pipeline.set_state(gst.STATE_PAUSED)
            self.button.set_active(False)
        elif msgtype == 'result':
            self.partial_result(msg.structure['hypothesis'], msg.structure['probability'])

    def partial_result(self, hyp, probability):
    ...
    def final_result(self, hyp, probability):
